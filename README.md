# HEART – Tecnica di Instradamento Adattivo in Ambiente Ospedaliero

Questo repository contiene il progetto **H.E.A.R.T** (Hospital Environment Adaptive Routing Technique), sviluppato per studiare il
